...
const PAGE_PATH = "/use-cases/mac-to-windows-clipboard";
...
const MacToWindowsPage = async ({ params }: PageProps) => {
  ...
  const rows: ComparisonRow[] = rawRows;
  ...
  const articleSchema = {
    ...
    about: [{ "@type": "SoftwareApplication", name: "UniClipboard" }],
  };
  ...
  const howToSchema = {
    ...
    totalTime: "PT5M",
    tool: [
      { "@type": "HowToTool", name: "Mac running macOS 12 or newer" },
      { "@type": "HowToTool", name: "Windows 10 or 11 PC" },
  ...
  return (
    <>
      ...
      <Footer />
      <JsonLd
        data={[articleSchema, howToSchema, faqSchema, breadcrumbSchema]}
      />
    </>
  );
};
